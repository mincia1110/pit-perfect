...
export class PitStopScene extends Phaser.Scene {
  ...
  create(): void {
    this.add.image(this.scale.width / 2, this.scale.height / 2, 'pit-markings').setDisplaySize(this.scale.width, this.scale.height).setAlpha(0.95);
    this.car = this.add.image(0, 0, 'hypercar');
